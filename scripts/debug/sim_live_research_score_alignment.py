...
def _run_execution_until_cooldown(execution, trade, mode="live"):
...
def main():
    ...
    try:
        ...
        execution.config["live_risk_per_trade"] = 0.005
        ...
        results.append(_assert(
            "execution.py live research score=2 is not blocked by score_filter",
            live_research.get("risk_percent") == 0.0025
        ...
        results.append(_assert(
            ...
            "risk_percent" not in normal_confirm
